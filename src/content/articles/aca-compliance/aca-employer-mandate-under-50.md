---
title: "Does the ACA Employer Mandate Apply to Businesses with Under 50 Employees?"
type: blog
excerpt: "The short answer: no. Small employers under 50 FTEs are not subject to the ACA employer mandate. Here's exactly what that means and what does still apply."
publishedDate: 2026-04-24
audienceTags: ["Business Leaders", "HR"]
topicTags: ["Compliance", "Getting Started"]
difficulty: beginner
contentCluster: ACA Compliance
seoTitle: "Does ACA Employer Mandate Apply to Under 50 Employees?"
seoDescription: "The federal ACA employer mandate does not apply to small businesses with fewer than 50 full-time-equivalent employees — here's what that means and what does still apply."
keywords:
  - ACA requirements small employer
  - ACA employer mandate under 50
  - small business ACA exempt
  - ACA requirements small business
  - is ACA mandate still in effect
keyTakeaways:
  - "No — the ACA employer mandate (Section 4980H) does NOT apply to employers with fewer than 50 full-time-equivalent (FTE) employees."
  - "Small employers under 50 FTEs have no federal penalty for choosing not to offer health insurance."
  - "Other ACA requirements may still apply if a small employer chooses to offer health coverage — particularly the plan compliance standards (preventive care, no annual limits, etc.)."
  - "Other federal compliance areas (ERISA, HIPAA, COBRA) apply independently of ACA size thresholds."
  - "ALE status is calculated annually based on the prior year's average FTE count, with specific rules for new businesses and seasonal workers."
faqs:
  - question: "Does the ACA employer mandate apply to small businesses?"
    answer: "No. The ACA employer mandate (Section 4980H) applies only to Applicable Large Employers (ALEs) — those with 50 or more full-time-equivalent (FTE) employees. Employers with fewer than 50 FTEs have no federal mandate to offer health insurance and no federal penalty for choosing not to offer it. ALE status is determined annually based on the prior year's workforce."
  - question: "What's the threshold for the ACA employer mandate?"
    answer: "50 full-time-equivalent employees, calculated as full-time employees (30+ hours per week) plus the FTE equivalent of part-time employees. The IRS provides a specific calculation methodology. ALE status is determined for the current calendar year based on the average FTE count from the prior year. Employers crossing the threshold partway through a year typically aren't subject to the mandate until the following year."
  - question: "Is the ACA employer mandate still in effect?"
    answer: "Yes. While the individual mandate's tax penalty was reduced to $0 by federal legislation, the employer mandate (Section 4980H) remains in effect. ALEs are still required to offer affordable, minimum-value coverage to substantially all full-time employees or face IRS penalties. The employer mandate has not been repealed."
  - question: "If I have 49 employees, do I need to comply with the ACA mandate?"
    answer: "Not for the employer mandate. At 49 FTEs you're below the ALE threshold and not subject to Section 4980H. But: if you're approaching 50 FTEs and growing, you should plan for ALE status before you cross the threshold. ACA reporting and compliance for ALEs requires several months of preparation. Don't wait until you've crossed the threshold to start planning."
  - question: "Do small employers have to file ACA Forms 1094-C and 1095-C?"
    answer: "No. ACA reporting under Forms 1094-C and 1095-C applies to ALEs (50+ FTEs). Small employers below the threshold are not required to file these forms. Some self-funded small employers may have separate reporting obligations under Forms 1094-B and 1095-B for their group health plans, regardless of ALE status."
  - question: "What ACA requirements apply if I'm a small employer who offers health insurance?"
    answer: "If you offer health insurance, the plan must comply with ACA standards: coverage of preventive services, no annual or lifetime dollar limits on essential benefits, dependent coverage to age 26, no discrimination based on pre-existing conditions, and other consumer protections. You must also distribute the Summary of Benefits and Coverage (SBC) and the Marketplace Notice. ERISA, HIPAA, and COBRA may also apply depending on your specifics."
...
[Health Insurance for Small Businesses with Under 10 Employees](/learn/fundamentals/health-insurance-under-10-employees) walks through the practical considerations.
...
> **Approaching the 50-FTE threshold or wondering whether you've already crossed it?** We can run the FTE calculation, walk through what compliance lifts apply now and at the next size milestone, and design benefits accordingly. [Talk to us](/talk-to-us).

[^1]: IRS, [Employer Shared Responsibility Provisions](https://www.irs.gov/affordable-care-act/employers/employer-shared-responsibility-provisions). The IRS guidance defines ALE status, the FTE calculation, exemptions, and the application of Section 4980H to employers above and below the threshold.
