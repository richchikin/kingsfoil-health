---
title: "ACA Reporting Requirements for Employers: A Practical Checklist"
type: blog
excerpt: "ACA reporting (Forms 1094-C and 1095-C) is required for ALEs. Here's what each form covers, when it's due, who needs to file what, and how to manage compliance without drowning."
publishedDate: 2026-04-24
audienceTags: ["Business Leaders", "HR", "CFO"]
topicTags: ["Compliance"]
difficulty: intermediate
contentCluster: ACA Compliance
seoTitle: "ACA Reporting Requirements for Employers: Practical Checklist"
seoDescription: "Complete checklist for ACA reporting under Forms 1094-C and 1095-C — who must file, what to include, deadlines, and how to manage compliance."
keywords:
  - ACA reporting requirements
  - 1094-C 1095-C
  - ACA reporting checklist
  - ALE reporting
  - employer ACA compliance
keyTakeaways:
  - "ACA reporting (Forms 1094-C and 1095-C) is required for Applicable Large Employers (ALEs) — those with 50+ full-time-equivalent employees."
  - "Form 1094-C is the transmittal form summarizing the employer's plan offering and ALE status. Form 1095-C is filed per full-time employee, detailing the offer of coverage."
  - "Filing deadlines: 1095-C distribution to employees by an IRS-set date in early March; 1094-C/1095-C IRS filing by an IRS-set date (paper filings earlier; electronic filings later)."
  - "Most ALEs use a benefits broker, payroll vendor, or specialized compliance vendor to handle the reporting work — the substantiation and accuracy requirements are non-trivial."
  - "Penalties for late, inaccurate, or missing forms are inflation-adjusted annually and can be substantial — accuracy and timeliness matter."
faqs:
  - question: "Who has to file ACA Forms 1094-C and 1095-C?"
    answer: "Applicable Large Employers (ALEs) — businesses with 50 or more full-time-equivalent employees in the prior calendar year. ALEs must file annually with the IRS and distribute Form 1095-C to employees. Small employers below the ALE threshold are not required to file these forms (though self-funded plans may have separate reporting under Forms 1094-B and 1095-B regardless of size)."
  - question: "What is Form 1095-C?"
    answer: "Form 1095-C is filed annually by ALEs for each full-time employee, documenting the offer of health coverage. It includes details about the employee, the coverage offered, the months coverage was available, and the employee's required contribution amount. Employees use the form (along with their tax return) to verify whether they received affordable employer coverage. Each ALE files multiple 1095-Cs — one per full-time employee."
  - question: "What is Form 1094-C?"
    answer: "Form 1094-C is the transmittal form for an ALE's annual ACA reporting. It summarizes the employer's status (ALE confirmation), member of an aggregated ALE group if applicable, total full-time employee count by month, and a summary of the offer of coverage. Each ALE files one 1094-C accompanying its 1095-Cs."
  - question: "When are ACA reporting forms due?"
    answer: "The IRS sets specific deadlines that may shift slightly year-to-year. Generally: Form 1095-C distribution to employees is due by an IRS-set date in early March; Forms 1094-C and 1095-C IRS filing is due by an IRS-set date (electronic filers have a later deadline than paper filers). Refer to the IRS instructions for the current year's specific dates."
  - question: "What are the penalties for failing to file 1094-C and 1095-C correctly?"
    answer: "ACA reporting penalties are set annually by the IRS, indexed for inflation. They apply to: failure to file with the IRS, failure to furnish 1095-Cs to employees, late filings, and inaccurate information. Per-form penalties can apply, and total annual penalties can be substantial for ALEs with many employees and significant errors. Refer to current IRS guidance for current-year specific dollar amounts."
  - question: "Can I do ACA reporting in-house or do I need a vendor?"
    answer: "It's possible to do in-house, but most ALEs use a specialized vendor or their benefits broker because the data requirements are substantial. Each 1095-C requires detailed monthly information about coverage, employment status, and affordability. Most payroll providers (ADP, Paychex, Gusto with extra services) and benefits brokers offer ACA reporting services. The cost is typically modest relative to the time and accuracy investment of doing it in-house."
...
If you're not sure whether you're an ALE, [Does the ACA Employer Mandate Apply to Businesses with Under 50 Employees?](/learn/aca-compliance/aca-employer-mandate-under-50) walks through the FTE calculation.
...
Pros: Single vendor for benefits and reporting; reduces coordination overhead
Cons: Broker may charge separately for reporting service
...
Pros: Reporting data flows directly from payroll
Cons: Coordination required between payroll vendor (for employment data) and benefits vendor (for plan details)
...
Pros: Deep expertise; built for the specific workflow
...
> **Need help establishing or improving your ACA reporting infrastructure?** We can connect you with reporting vendors, integrate ACA reporting with your benefits administration, and ensure your data flow supports accurate annual filings. [Talk to us](/talk-to-us).

[^1]: IRS, [Affordable Care Act Information Returns (AIR)](https://www.irs.gov/affordable-care-act/employers/affordable-care-act-information-returns-air) and [Section 4980H Employer Shared Responsibility Provisions](https://www.irs.gov/affordable-care-act/employers/employer-shared-responsibility-provisions). Refer to current-year IRS guidance for specific filing deadlines, form instructions, and penalty amounts.
