---
title: "Health Reimbursement Arrangements 101: A Plain-English Guide"
type: blog
excerpt: "Health reimbursement arrangements (HRAs) let employers fund employee healthcare costs with pre-tax dollars. Here's what they are, how they work, and the different types small businesses can offer."
publishedDate: 2026-04-24
audienceTags: ["Business Leaders", "HR", "All"]
topicTags: ["Plan Structures", "Benefits Strategy", "Getting Started"]
difficulty: beginner
contentCluster: HRA & Reimbursement
isFeatured: true
seoTitle: "Health Reimbursement Arrangements (HRA) 101: Plain-English Guide"
seoDescription: "What is a health reimbursement arrangement (HRA)? A complete plain-English guide to HRAs for employers — the types, how they work, tax treatment, and when each fits."
keywords:
  ...
  - HRA explained
keyTakeaways:
  - "A health reimbursement arrangement (HRA) is an IRS-approved, employer-funded account that reimburses employees for qualified medical expenses on a tax-free basis."
  - "Employers control the amount, the rules, and what counts as a qualified expense (within IRS limits). Employees pay for care, submit a receipt, and get reimbursed pre-tax."
  - "The main types small businesses encounter: ICHRA (Individual Coverage HRA), QSEHRA (Qualified Small Employer HRA), Integrated HRA (paired with a group plan), and Excepted Benefit HRA."
  - "HRAs are funded only by the employer — unlike HSAs, employees can't contribute. Unused HRA funds can roll over or be forfeited depending on plan design."
  - "ICHRAs and QSEHRAs especially have gained traction for small employers because they let businesses offer meaningful benefits without sponsoring a traditional group plan."
faqs:
  - question: "What is a health reimbursement arrangement (HRA)?"
    answer: "An HRA is an employer-funded, IRS-approved account that reimburses employees for qualified medical expenses on a tax-free basis. The employer decides how much to contribute and what expenses qualify (within IRS rules). Employees pay for eligible care, submit documentation, and receive tax-free reimbursement up to the HRA's annual amount. HRAs are funded only by the employer — employees cannot contribute to them."
  - question: "What are the different types of HRAs?"
    answer: "The main types: (1) Integrated HRA — paired with a traditional group health plan to reimburse cost-sharing; (2) ICHRA (Individual Coverage HRA) — reimburses employees who buy individual market coverage; (3) QSEHRA (Qualified Small Employer HRA) — a simpler variant for employers under 50 employees; (4) Excepted Benefit HRA — covers limited benefits like dental and vision. Each has different rules, limits, and use cases."
  - question: "What's the difference between an HRA and an HSA?"
    answer: "An HRA is an employer-funded reimbursement account; the employer owns the funds, sets the rules, and decides whether unused balances roll over. An HSA is an individual-owned tax-advantaged savings account that requires HDHP enrollment; the employee owns the funds, can contribute their own pre-tax money, and keeps the balance regardless of employment. HRAs and HSAs can sometimes coexist depending on the HRA's design."
  - question: "Are HRA reimbursements taxable to employees?"
    answer: "No, when properly structured, HRA reimbursements are excluded from the employee's gross income and are not subject to FICA/Medicare tax. They're tax-free to the employee and tax-deductible to the employer. The IRS sets specific rules about what qualifies, how documentation must be maintained, and how plans must be designed to preserve the tax-free treatment."
  - question: "What expenses can an HRA reimburse?"
    answer: "Generally, qualified medical expenses as defined by IRS Section 213(d) — doctor visits, prescriptions, dental, vision, mental health, certain over-the-counter items, and health insurance premiums (depending on the HRA type). The specific list of eligible expenses for any given HRA depends on the plan design and the type of HRA. The IRS publishes guidance on qualified medical expenses in Publication 502."
  - question: "Can a small business offer an HRA without offering group health insurance?"
    answer: "Yes. ICHRAs and QSEHRAs are specifically designed to let employers offer pre-tax healthcare benefits without sponsoring a traditional group plan. Employees use the employer's HRA contribution to buy individual market coverage and pay other qualified medical expenses, with reimbursements flowing tax-free. This has made HRAs especially popular for small employers."
...
[ICHRA Explained: The Complete Employer's Guide](/learn/hra-ichra/ichra-explained) covers this one in depth.
...
5. **Reimbursement.** Employee submits a claim with documentation through the HRA admin (often a vendor). The vendor verifies and pays the employee tax-free up to the HRA's available balance.
6. **Year-end.** Depending on plan design, unused balances either roll over or are forfeited.
...
**Step 2: Pick the type.** The IRS rules are specific about which type fits which scenario. A benefits advisor can model the options; the [IRS HRA guidance](https://www.irs.gov/affordable-care-act/employer-payment-plans) is the primary source.
...
**Step 5: Communicate to employees.** HRAs work best when employees actually understand them. Plan enrollment communication accordingly. [Enrollment Communications That Actually Work](/learn/hr-playbook/enrollment-communications) covers this for any benefits change.
...
If you're evaluating any of these structures, the first decision is which type fits your business. Start with [ICHRA Explained](/learn/hra-ichra/ichra-explained) if you're considering replacing or augmenting a group plan, [HRA vs HSA](/learn/hra-ichra/hra-vs-hsa) if you're choosing between funding mechanisms, or [ICHRA vs QSEHRA](/learn/hra-ichra/ichra-vs-qsehra) if you're choosing between the two HRA variants for a small business.

> **Want help modeling whether an HRA fits your business?** We can walk through the four types, run the numbers against your current spend, and identify whether an HRA-based approach would deliver better economics or coverage. [Talk to us](/talk-to-us).

[^1]: IRS, [Publication 969 — Health Savings Accounts and Other Tax-Favored Health Plans](https://www.irs.gov/publications/p969), and IRS guidance on [Health Reimbursement Arrangements](https://www.irs.gov/affordable-care-act/employer-payment-plans). The IRS publishes annual contribution limits for QSEHRA and Excepted Benefit HRAs, and detailed rules for ICHRA design and administration. Refer to current-year IRS guidance for specific dollar limits.
[^2]: IRS guidance on [HRAs and the tax treatment of employer-provided health coverage](https://www.irs.gov/affordable-care-act/employer-payment-plans). Properly structured HRA reimbursements are excluded from gross income under IRC §105 and not subject to FICA, FUTA, or Medicare taxes when the employer follows the documentation and substantiation requirements.
