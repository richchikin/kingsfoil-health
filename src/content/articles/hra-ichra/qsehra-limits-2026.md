---
title: "QSEHRA Limits for 2026: What Small Employers Need to Know"
type: blog
excerpt: "QSEHRA contribution limits are set by the IRS each year and indexed for inflation. Here's how to find current-year limits, why they matter, and how to use them in plan design."
publishedDate: 2026-04-24
audienceTags: ["Business Leaders", "HR"]
topicTags: ["Plan Structures", "Compliance", "Benefits Strategy"]
difficulty: intermediate
contentCluster: HRA & Reimbursement
seoTitle: "QSEHRA Limits 2026: IRS Contribution Caps for Small Employers"
seoDescription: "How to find and apply the IRS-set 2026 QSEHRA contribution limits, why limits exist, and what to do if you want to contribute more than the cap allows."
keywords:
  - QSEHRA limits 2026
  - QSEHRA contribution limits
  - 2026 QSEHRA maximum
  - small employer HRA limits
  - QSEHRA rules
keyTakeaways:
  - "QSEHRA contribution limits are set by the IRS each year in a Revenue Procedure and indexed for inflation."
  - "Separate limits apply for self-only coverage and family coverage; the family limit is higher than the self-only limit."
  - "The IRS publishes current-year limits well before the start of the plan year — refer to the IRS guidance for current dollar amounts."
  - "If you want to contribute above the QSEHRA cap, an ICHRA is the alternative — ICHRA has no IRS-set contribution limit."
  - "QSEHRAs are restricted to employers with fewer than 50 full-time-equivalent employees who don't offer a traditional group health plan."
faqs:
  - question: "What are the 2026 QSEHRA contribution limits?"
    answer: "The IRS publishes annual QSEHRA contribution limits in a Revenue Procedure each year, indexed for inflation. Separate limits apply for self-only coverage and family coverage. For specific 2026 dollar amounts, refer to the most recent IRS QSEHRA guidance — the dollar figures are published well before the start of the plan year."
  - question: "Are QSEHRA limits set by the IRS or by the employer?"
    answer: "The maximum contribution is set by the IRS; the employer chooses any amount up to the cap. The IRS limits exist to keep QSEHRAs aligned with their original Congressional purpose: helping small employers offer a meaningful but capped healthcare benefit. Employers wanting to contribute above the QSEHRA limit have to use a different structure (ICHRA, which has no IRS-set cap)."
  - question: "Where can I find the official QSEHRA limits?"
    answer: "The IRS publishes QSEHRA contribution limits in annual Revenue Procedures. The limits are also referenced in IRS Publication 15-B (Employer's Tax Guide to Fringe Benefits). The most reliable source is irs.gov directly. The limits are typically announced in the late spring or summer of the prior year, giving employers time to plan."
  - question: "Why are there separate QSEHRA limits for self-only and family coverage?"
    answer: "The IRS recognizes that family coverage costs significantly more than self-only coverage in the individual market. The separate limits let employers offer differentiated reimbursement amounts that reflect the actual cost difference, without violating the QSEHRA's uniformity requirements (the same structure applies to all eligible employees, but families can receive higher reimbursements than singles)."
  - question: "Can a small employer offer more than the QSEHRA limit?"
    answer: "Not within a QSEHRA — the IRS-set cap is the maximum. To contribute above the QSEHRA limit, the employer would need to use an ICHRA (Individual Coverage HRA), which has no IRS-set contribution cap. The trade-off is that ICHRA has slightly more compliance complexity than QSEHRA. For employers committed to higher contributions, ICHRA is the path."
  - question: "What happens if a QSEHRA contribution exceeds the IRS limit?"
    answer: "Contributions above the IRS-set limit are not 'qualified' under QSEHRA rules and would lose the favorable tax treatment for the excess amount. Employers structuring a QSEHRA need to stay within the limits. If higher contributions are needed, the structure should be an ICHRA instead of a QSEHRA."
...
- **Primary source:** [IRS Publication 15-B (Employer's Tax Guide to Fringe Benefits)](https://www.irs.gov/publications/p15b)
...
[ICHRA vs QSEHRA](/learn/hra-ichra/ichra-vs-qsehra) walks through the full comparison. The summary:
...
1. **Confirm employer eligibility** — must be under 50 FTEs and offer no group health plan
2. **Check the current-year IRS limits** for both self-only and family coverage
3. **Decide your contribution amount** within the cap, considering budget, goals, and competitive market
4. **Adopt or update the written plan document** to reflect contribution amounts
5. **Provide required notice** to eligible employees (specific timing required by IRS)
6. **Coordinate with payroll** for proper W-2 reporting (QSEHRA amounts must be reported)
7. **Use a third-party administrator** for substantiation and reimbursements unless the employer has the bandwidth to handle it directly
...
> **Want help applying the current QSEHRA limits to your business?** We can help you size your contribution within the cap, model the tax economics, and decide whether QSEHRA or ICHRA is the better fit for your specific situation. [Talk to us](/talk-to-us).

[^1]: IRS, [Publication 15-B (Employer's Tax Guide to Fringe Benefits)](https://www.irs.gov/publications/p15b), and annual Revenue Procedures publishing inflation-adjusted limits. The QSEHRA structure was created by the 21st Century Cures Act of 2016; see also IRS [QSEHRA guidance](https://www.irs.gov/affordable-care-act/employer-payment-plans).
