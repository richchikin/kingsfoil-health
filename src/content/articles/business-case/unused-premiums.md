---
title: "Where Do Your Unused Premiums Go?"
type: blog
excerpt: "When your employees are healthy and claims are low, someone benefits from that surplus. In most plans, it's not you. Here's how different plan structures handle unused premiums."
...
trackOrder: 3
isFeatured: false
seoTitle: "Where Do Unused Health Insurance Premiums Go?"
seoDescription: "What happens to your health insurance premiums when claims are low? How surplus works in fully funded, level-funded, and self-funded plans."
keywords:
...
readingTime: 7
keyTakeaways:
  - "In a fully-funded plan, unused premiums — money left over when claims come in below projection — stay with the insurance carrier as profit."
  - "In a level-funded plan, unused premiums typically return to the employer as a surplus refund at year-end (though the split varies by carrier)."
  - "In a fully self-funded plan, unused claims funding stays with the employer automatically — there's no carrier in the middle to keep it."
  - "Over multi-year horizons, the compounding value of retained surplus can be substantial — real money most employers never capture."
  - "The federal medical loss ratio (MLR) rule sets minimum proportions of premium that carriers must spend on claims/quality but does not force carriers to refund surplus to individual employers."
faqs:
  - question: "What happens to unused health insurance premiums?"
    answer: "It depends on the plan structure. In a fully-funded plan, unused premiums stay with the insurance carrier. In a level-funded plan, surplus from a good claims year typically returns to the employer as a refund. In a fully self-funded plan, there's no carrier taking premium in the first place — any money not spent on claims simply stays in the employer's claims account."
  - question: "Do insurance companies refund premiums if claims are low?"
    answer: "Fully-funded carriers generally do not refund unused premiums to individual employers. The federal Medical Loss Ratio (MLR) rule under the ACA requires carriers to spend a minimum share of premiums on claims and quality improvement or send rebates to the market in aggregate, but this rarely results in meaningful individual refunds. Level-funded plans, by contrast, are structured to return surplus directly to the employer.[^1]"
  - question: "How much money do employers typically leave on the table with fully-funded plans?"
    answer: "For healthy groups, the surplus a fully-funded carrier retains in a favorable claims year can be a meaningful share of total premiums. Compounded over multi-year horizons, that's significant money that alternative plan structures let the employer capture instead. Specific outcomes vary with group claims experience."
  - question: "How is surplus calculated in a level-funded plan?"
    answer: "At year-end, actual claims are compared to the expected claims amount built into the monthly payment. If actual claims are lower than expected, the difference (sometimes less a carrier 'holdback' percentage) is refunded to the employer. Specific calculations vary by carrier: some refund the full surplus, others split it, and some apply it as a credit against next year's premium."
