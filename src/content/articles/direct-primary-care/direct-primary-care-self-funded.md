---
title: "How Direct Primary Care + Self-Funded Health Plans Lower Claims Costs"
type: blog
excerpt: "Pairing DPC with a self-funded plan moves primary care utilization out of the insurance claims pipeline — improving employee experience and reducing employer claims spend."
...
seoTitle: "DPC + Self-Funded Plans: How They Lower Claims Costs"
seoDescription: "How pairing direct primary care with a self-funded health plan reduces claims costs while improving employee primary care experience."
keywords:
  - direct primary care self funded
  - DPC self funded plan
  - DPC level funded
  - direct primary care reduce claims
  - DPC ROI for employers
keyTakeaways:
  - "Pairing DPC with a self-funded health plan moves primary care utilization out of the insurance claims pipeline — directly reducing employer claims spend."
  - "The savings flow directly to the employer in self-funded structures because the employer pays claims directly; in fully-insured plans, the savings flow to the carrier."
  - "DPC pairs especially well with HDHPs because routine primary care doesn't accumulate against the deductible (it's outside the insurance plan)."
  - "Beyond claims savings, DPC produces measurably better primary care experience — addressing both cost and quality at the same time."
  - "The implementation requires coordination among the DPC practice, the TPA, and the benefits advisor, but the structure is well-established for self-funded employers."
faqs:
  - question: "How does DPC reduce claims costs for self-funded employers?"
    answer: "DPC moves primary care utilization out of the insurance claims pipeline. Office visits, basic in-office labs, basic procedures, and wholesale-cost prescription dispensing happen outside the health plan — they don't generate claims. For a self-funded employer paying claims directly, fewer claims means lower direct claims spend. The savings depends on how much primary care utilization your population has, but for typical workforces, DPC investments often more than pay for themselves through claims reduction."
  - question: "Why does DPC pair better with self-funded than fully-insured?"
    answer: "In self-funded plans, the employer pays claims directly, so claims reductions from DPC flow to the employer's bottom line. In fully-insured plans, the carrier pays claims, so the savings from reduced primary care claims flow to the carrier — the employer pays the same fixed premium regardless. The financial case for DPC is structurally stronger when the employer captures the savings."
  - question: "How does DPC interact with HDHPs and HSA eligibility?"
    answer: "DPC pairs naturally with HDHPs: the HDHP handles catastrophic and specialty care, and DPC handles routine primary care that would otherwise count against the deductible. The IRS has issued guidance on the interaction between DPC and HSA eligibility, and recent legislation has expanded DPC-HSA compatibility in some scenarios. Plan design needs to navigate these rules carefully — work with a benefits advisor familiar with current IRS guidance."
  - question: "What does it cost to add DPC to a self-funded plan?"
    answer: "The direct cost is the DPC membership fee per employee per month. Adult memberships are commonly in the $50-$150 per month range. The fee is offset by reduced claims spend in the self-funded plan, so the total-cost impact is often net-zero to net-positive. The employer pays the membership; the plan pays fewer claims. Whether the math works depends on your specific population's primary care utilization and the cost of the DPC membership."
  - question: "How is DPC documented and integrated with the health plan?"
    answer: "Typically the DPC practice operates as a separate vendor relationship, with employees accessing the DPC outside the insurance plan. The TPA continues to handle the insurance claims pipeline normally. The DPC and the TPA coordinate on specialist referrals (DPC physician refers; specialist visit goes through insurance), but they're operationally distinct. Some advanced setups integrate DPC into the plan design more deeply, but this is more complex."
  - question: "Should every self-funded employer add DPC?"
    answer: "Not every. DPC fits well when DPC practices are accessible in employee geographies and your population uses primary care meaningfully. For workforces in areas without DPC presence, or for populations that primarily access specialty care rather than primary care, the value is harder to capture. Evaluate practice availability and your claims utilization patterns before committing."
...
Without this communication, employees may not engage with the DPC, reducing the value of the investment. [Enrollment Communications That Actually Work](/learn/hr-playbook/enrollment-communications) covers this for benefits changes generally.
...
> **Want help evaluating whether DPC + self-funded fits your business?** We can map DPC practice availability against your employees, model the claims-spend impact, and design the integration. [Talk to us](/talk-to-us).
...
[^2]: IRS guidance on Direct Primary Care arrangements and HSA eligibility has evolved through multiple notices and recent legislation. See [IRS Publication 969](https://www.irs.gov/publications/p969) and current IRS guidance for the most recent rules. Plan design should reflect current guidance to preserve HSA eligibility.
