---
title: "What Is Stop-Loss Insurance and Why Every Self-Funded Employer Needs It"
type: blog
excerpt: "Stop-loss insurance is the mechanism that caps an employer's financial risk under a self-funded health plan. Here's how it works, what it costs, and why it makes alternative plan structures safe even for small companies."
publishedDate: 2026-04-24
audienceTags: ["Business Leaders", "CFO"]
topicTags: ["Plan Structures", "Benefits Strategy", "Getting Started"]
difficulty: beginner
contentCluster: Stop-Loss
seoTitle: "What Is Stop-Loss Insurance in Healthcare?"
seoDescription: "A plain-English guide to stop-loss insurance for self-funded employers. How it works, the two types (specific and aggregate), what it costs, and why it's non-negotiable."
keywords:
  - stop loss insurance
  ...
  - employer stop loss
keyTakeaways:
  - "Stop-loss insurance is a separate policy that caps an employer's financial exposure under a self-funded or level-funded health plan."
  - "There are two types: specific stop-loss (protects against any one employee's claims exceeding a threshold) and aggregate stop-loss (protects against total group claims exceeding projections)."
  - "Without stop-loss, a single catastrophic claim could sink a small employer's plan. With it, the worst-case outcome is defined and predictable."
  - "Specific attachment points are dollar thresholds; aggregate is typically expressed as a percentage above projected annual claims. Both are negotiated based on group profile and risk tolerance."
  - "Stop-loss is non-negotiable for any self-funded or level-funded plan — the question isn't whether to buy it, but how much coverage to buy and from which carrier."
faqs:
  - question: "What is stop-loss insurance in healthcare?"
    answer: "Stop-loss insurance is a financial protection policy that employers with self-funded or level-funded health plans buy to cap their exposure to large claims. It sits behind the health plan — the employer pays claims directly up to a defined threshold, and the stop-loss carrier reimburses the employer for claims above that threshold. It's what makes self-funded plans financially viable for companies that aren't large enough to absorb catastrophic risk on their own."
  - question: "Who needs stop-loss insurance?"
    answer: "Any employer with a self-funded or level-funded health plan needs stop-loss insurance. Fully-insured plans don't need it because the carrier already takes on all claims risk. For self-funded arrangements, stop-loss is non-negotiable — without it, a single catastrophic medical event could blow up the plan budget."
  ...
  - question: "What is the difference between specific and aggregate stop-loss?"
    answer: "Specific stop-loss protects against claims from any single covered person exceeding a defined dollar threshold for the year. Aggregate stop-loss protects against total claims from the whole group exceeding an expected amount (typically expressed as a percentage above projected annual claims). Most employers carry both types — they protect against different failure modes."
  - question: "What happens if my stop-loss carrier goes out of business?"
    answer: "This is why carrier financial strength matters. Major stop-loss carriers carry strong A.M. Best ratings and are regulated as insurance companies, so the risk of insolvency is low. If it did happen, state guaranty associations typically cover claims up to statutory limits, and any unpaid claims could be pursued through the bankruptcy process. Your benefits advisor should only place you with highly-rated carriers for exactly this reason."
  - question: "Is stop-loss insurance the same as reinsurance?"
    answer: "They're similar but not identical. Both are insurance purchased to cap risk on another insurance product. 'Stop-loss' is the specific term used in the employer health plan market, where the coverage is purchased directly by the self-funded employer. 'Reinsurance' typically refers to coverage that one insurance company buys to cap its own exposure — though the terms are sometimes used interchangeably in conversation."
...
[Aggregate vs. Specific Stop-Loss](/learn/stop-loss/aggregate-vs-specific-stop-loss) walks through the differences in much more depth, including how to decide what attachment points are right for your group.
...
[Stop-Loss Insurance Explained with Real Examples](/learn/stop-loss/stop-loss-insurance-examples) walks through more scenarios with different plan sizes and attachment points if you want to see the numbers play out more fully.
...
> **Trying to make sense of a stop-loss quote?** We can review the attachment points, lasering provisions, and contract terms and tell you honestly whether the coverage is right for your group. [Talk to us](/talk-to-us).
