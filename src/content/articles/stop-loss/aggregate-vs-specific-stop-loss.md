---
title: "Aggregate vs. Specific Stop-Loss: How Employers Protect Against Catastrophic Claims"
type: blog
excerpt: "The two types of stop-loss insurance — specific and aggregate — protect against different failure modes. Here's how they work together, what attachment points to choose, and why most employers need both."
publishedDate: 2026-04-24
audienceTags: ["Business Leaders", "CFO"]
topicTags: ["Plan Structures", "Benefits Strategy", "Claims & Data"]
difficulty: intermediate
contentCluster: Stop-Loss
seoTitle: "Aggregate vs. Specific Stop-Loss Insurance: Employer's Guide"
seoDescription: "A detailed comparison of specific and aggregate stop-loss insurance — how each works, how attachment points are set, and how to decide the right levels."
keywords:
  - aggregate vs specific stop loss
  - specific stop loss insurance
  - aggregate stop loss insurance
  - stop loss attachment point
  - individual stop loss
keyTakeaways:
  - "Specific stop-loss protects against any one employee's claims exceeding a threshold; aggregate stop-loss protects against total group claims exceeding an expected amount."
  - "Most self-funded and level-funded plans carry both — they protect against different failure modes (one catastrophic claim vs. a cumulatively bad year)."
  - "Specific attachment points are dollar thresholds chosen at policy purchase; aggregate is typically expressed as a percentage above projected annual claims."
  - "Lowering your specific attachment point increases protection but raises premium; the right level depends on your group size, cash position, and risk tolerance."
  - "Aggregate stop-loss is almost always included in level-funded plans. Fully self-funded employers sometimes drop aggregate once they're large enough that aggregate failure becomes statistically unlikely and the premium savings are meaningful."
faqs:
  - question: "What is the difference between specific and aggregate stop-loss?"
    answer: "Specific stop-loss protects the employer against any single covered person's claims exceeding a defined threshold (e.g., one employee generates $300,000 in claims). Aggregate stop-loss protects against the total claims of the whole group exceeding an expected amount (e.g., total group claims hit 135% of projections). Specific addresses the 'one bad claim' risk; aggregate addresses the 'bad year' risk."
  - question: "Do I need both specific and aggregate stop-loss?"
    answer: "Most employers carry both. Specific alone leaves you exposed to scenarios where lots of moderate claims pile up without any single person triggering the attachment point. Aggregate alone leaves you exposed to a single employee's catastrophic claim. The combination caps your total worst-case exposure under both failure modes. Level-funded plans typically bundle both by default."
  - question: "How is a specific stop-loss attachment point chosen?"
    answer: "The specific attachment point is a dollar threshold negotiated at policy purchase. The right level balances protection (lower attachment = more protection, higher premium) against cost (higher attachment = lower premium, more employer risk). Group size, cash flow tolerance, demographics, and claims history all factor in. Your benefits advisor models the trade-off based on your specific group."
  - question: "How is an aggregate attachment point calculated?"
    answer: "Aggregate attachment is calculated as a percentage above expected annual claims. The carrier estimates expected claims based on demographics, historical data, and plan design, then applies the aggregate factor. For illustration: if expected claims were $400,000 and the aggregate factor was 125%, the aggregate attachment point would be $500,000. Total group claims above that amount are reimbursed by the stop-loss carrier."
  - question: "Can I lower my specific attachment point to get more protection?"
    answer: "Yes, carriers will quote a range of attachment points. Lower attachment means more protection but higher premium; higher attachment means less protection but lower premium. Modeling the math — how much does the premium change at each level, and what's the probability of claims hitting each threshold — is part of what a good benefits advisor does before renewal."
  - question: "Why would a large employer drop aggregate stop-loss?"
    answer: "Employers with larger groups and stable historical claims sometimes drop aggregate because their group is large enough that aggregate failure becomes statistically unlikely, and the premium savings can be meaningful. Specific stop-loss is almost always retained. This is an advanced move that depends on the group's specific profile and should be modeled carefully — dropping aggregate introduces real tail risk for groups that aren't large enough to absorb it."
...
1. **Estimate monthly expected claims** per-employee-per-month (PEPM), based on demographics and prior experience.
2. **Multiply** by number of employees and by 12 months to get expected annual claims.
3. **Multiply** by the aggregate factor (a percentage above projected claims, set at policy purchase).
...
[Stop-Loss Insurance Explained with Real Examples](/learn/stop-loss/stop-loss-insurance-examples) runs through several scenarios with specific numbers to show how this math plays out in practice.
...
**3. Model the total cost.** Premium savings from raising attachments only make sense if the probability-weighted cost of claims at the higher attachment is lower than the premium you'd save. A good advisor runs this math with multiple scenarios. [ROI Modeling](/learn/business-case/roi-modeling) is a useful primer on this kind of analysis.
...
[^1]: All dollar amounts and percentages in this article (attachment points, expected claims, aggregate factors, illustrative scenarios) are illustrative examples for explanation. Actual stop-loss attachment points, premiums, factors, and reimbursement amounts vary by group size, demographics, claims experience, and carrier. Specific numbers in your quote will reflect your particular group's profile.
