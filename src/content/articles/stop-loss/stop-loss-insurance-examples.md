---
title: "Stop-Loss Insurance Explained with Real Examples: What Happens When Claims Hit"
type: blog
excerpt: "Three detailed scenarios that show exactly how specific and aggregate stop-loss insurance pay out when real claims happen — including the numbers, the timing, and the employer's actual net cost."
publishedDate: 2026-04-24
audienceTags: ["Business Leaders", "CFO"]
topicTags: ["Plan Structures", "Claims & Data", "Benefits Strategy"]
difficulty: intermediate
contentCluster: Stop-Loss
seoTitle: "Stop-Loss Insurance Examples: Real Scenarios with Numbers"
seoDescription: "Worked examples of stop-loss insurance — a catastrophic claim, a bad aggregate year, and a healthy year. See the numbers, payouts, and employer net cost."
keywords:
  - stop-loss health insurance example
  - stop loss insurance example
  - how does stop loss insurance work
  - stop loss claim scenarios
  - stop loss reimbursement
keyTakeaways:
  - "A single $300,000 claim under a self-funded plan with $75,000 specific stop-loss costs the employer $75,000 — the stop-loss carrier reimburses the remaining $225,000."
  - "Aggregate stop-loss protects against a bad year overall, even when no single claim is catastrophic; typical trigger is total claims exceeding 120–125% of projections."
  - "Employers pay claims out of their plan's claims fund first, then file a stop-loss reimbursement request with documentation; reimbursement typically arrives within 15–30 days."
  - "In a healthy claims year, stop-loss simply doesn't pay out — you paid the premium for protection you didn't need, and that's the point."
  - "Real stop-loss math rarely matches the 'worst-case' scenarios people imagine — for most healthy groups, the protection is triggered 0–1 times per year."
faqs:
  - question: "Can you show an example of how stop-loss insurance works?"
    answer: "Yes. Imagine a 50-employee self-funded plan with a $75,000 specific stop-loss attachment. An employee needs a $300,000 surgery. The employer's plan pays the first $75,000 from the claims fund. The employer then files a reimbursement request with the stop-loss carrier for the remaining $225,000, which is paid back to the plan within 15–30 days. The employer's net exposure on that catastrophic claim is capped at $75,000."
  - question: "How fast does a stop-loss carrier pay reimbursement claims?"
    answer: "Once an individual claim crosses the specific attachment point, the employer (or the TPA on their behalf) files a reimbursement request with the stop-loss carrier, with documentation of the claim. Reimbursement typically arrives within 15–30 days. For aggregate reimbursement, the process happens at year-end once total claims are reconciled against the aggregate attachment point."
  - question: "What documentation does a stop-loss carrier require for reimbursement?"
    answer: "Stop-loss carriers require claims-level documentation showing the dates of service, amounts billed, amounts paid by the plan, and the identity of the claimant. This is typically generated automatically by the third-party administrator (TPA) running the plan. Well-run TPAs handle the reimbursement filing on the employer's behalf as part of their administrative services."
  - question: "Do you still pay stop-loss premiums in a year when there are no large claims?"
    answer: "Yes. Stop-loss is insurance — you pay the premium whether or not claims are triggered, just like any other insurance policy. In a year when no claims exceed the attachment points, stop-loss doesn't pay out. That's a feature, not a bug: you paid for protection against catastrophic variance, and you didn't need it that year. The premium is the cost of bounded worst-case exposure."
  - question: "What happens if an employee's claim is still ongoing at the end of the plan year?"
    answer: "How ongoing claims are handled depends on whether your stop-loss contract is written on a paid basis or an incurred basis. Paid contracts cover claims paid during the policy period. Incurred contracts cover claims incurred during the period regardless of when paid — which usually provides better coverage for long-tail claims. Most mid-market policies include run-in and run-out provisions that address the transitions between plan years."
  - question: "How does a laser affect stop-loss payouts?"
    answer: "A laser is a carrier-imposed higher specific attachment point for a named individual, usually someone with a known high-cost condition. For example, if your standard attachment is $75,000 but one employee is lasered at $200,000, the employer must absorb claims up to $200,000 for that individual before stop-loss reimburses. This can significantly affect your net cost if the lasered individual has a major claim."
...
[How Claims Data Changes Your Plan Strategy](/learn/business-case/claims-data) walks through how to read this kind of experience data in real plan reports and what to do with it.

## What the three scenarios tell you

Put the three outcomes side by side:

| Scenario | Total claims | Stop-loss reimbursement | Net employer cost |
|---|---|---|---|
...
The protection isn't theoretical. It's arithmetic. And for any employer considering a [self-funded](/learn/plan-structures/self-funded-vs-fully-insured) or [level-funded plan](/learn/plan-structures/level-funded-health-plans-explained), modeling these scenarios with your actual numbers is what turns "this sounds risky" into "this is a calculated decision with a defined worst case."

> **Want to see these scenarios run with your actual group's numbers?** We can build a stress-test model with your demographics, expected claims, and proposed stop-loss structure to show you exactly what the range of outcomes looks like. [Talk to us](/talk-to-us).

[^1]: All scenarios in this article are illustrative — the company, claims amounts, attachment points, and outcomes are constructed examples for explanation. Actual stop-loss attachment points, premium rates, claims volumes, and reimbursement amounts vary widely by group size, demographics, claims experience, plan design, and which carrier writes the coverage. Modeling against your specific group's data is the only way to project realistic outcomes.
