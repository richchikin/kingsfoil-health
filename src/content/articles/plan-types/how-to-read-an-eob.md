...
type: blog
excerpt: "An Explanation of Benefits looks like a bill but isn't one. Here's how to read it line by line, what each number means, and what to actually do when you receive one."
publishedDate: 2026-04-24
audienceTags: ["Employee", "All", "HR"]
topicTags: ["Plan Structures", "Getting Started"]
difficulty: beginner
contentCluster: Plan Types
seoTitle: "How to Read an Explanation of Benefits (EOB): Line-by-Line Guide"
seoDescription: "What an Explanation of Benefits (EOB) is, how to read each line, and what action (if any) to take when you receive one from your health insurance carrier."
keywords:
...
keyTakeaways:
  - "An Explanation of Benefits (EOB) is a statement from your health insurance carrier showing how a claim was processed — it is NOT a bill."
  - "An EOB shows: the service provided, what the provider charged, what the plan negotiated, what the plan paid, and what you owe (if anything)."
  - "The provider sends you a separate bill for the amount you owe — the EOB and the bill should match."
  - "If they don't match, contact the provider's billing office or your carrier's customer service before paying."
  - "Save EOBs for at least a year, especially for high-cost services — they're useful if you need to dispute a charge or track your deductible/OOP progress."
faqs:
  - question: "What is an Explanation of Benefits (EOB)?"
    answer: "An Explanation of Benefits is a statement from your health insurance carrier showing how a specific claim was processed. It typically arrives by mail or in your insurance portal a few weeks after you receive medical care. The EOB explains what service was provided, what the provider charged, what the plan negotiated and paid, and what (if anything) you owe. It's important to know: an EOB is NOT a bill. The provider will send a separate bill for any amount you owe."
  - question: "Is an EOB a bill?"
    answer: "No. An EOB shows you how the insurance carrier processed your claim — it tells you what they paid, what was negotiated off, and what you might owe. The actual bill comes from the provider (the doctor, hospital, or facility) and should arrive separately. EOBs typically print 'This is not a bill' prominently for this reason."
  - question: "What should I do when I receive an EOB?"
    answer: "Three steps: (1) Check the service description, date, and provider against your memory of the visit; (2) Compare the 'patient responsibility' or 'amount you owe' against any bill you receive from the provider — they should match; (3) If they don't match, call the provider's billing office or your insurance carrier before paying. Save the EOB for at least a year. If everything checks out, no action is required from you on the EOB itself."
  - question: "What do the different lines on an EOB mean?"
    answer: "Common EOB lines: 'amount billed' (what the provider charged), 'plan discount' or 'allowed amount' (the negotiated rate), 'plan paid' (what the carrier paid), 'deductible' (amount applied to your deductible), 'coinsurance' (your percentage share), 'copay' (your flat amount), and 'patient responsibility' or 'amount you owe' (the total of your cost-sharing). The exact labels vary by carrier."
  - question: "How long should I keep my EOBs?"
    answer: "Save EOBs for at least one year. For major procedures or expensive services, save them longer (3-5 years) — they're useful if you need to dispute a charge, file an insurance claim later, or document medical expenses for tax purposes. Many people scan or save digital copies through their insurance portal rather than keeping paper."
  - question: "What if my EOB shows charges I don't recognize?"
    answer: "Call your insurance carrier's customer service number on the EOB to question the charges. Possible explanations: a service was billed under a different name than you'd recognize, a service was provided you weren't aware of, or there's a billing error. Healthcare billing errors are common, and EOBs are how you catch them."
...
[How Concierge vs. Call Center Affects Employee Experience](/learn/hr-playbook/concierge-vs-call-center) covers why having someone to help with this matters — billing disputes are one of the things concierge benefits services handle on the employee's behalf.
...
> **Have a confusing EOB or billing dispute?** This is exactly the kind of thing a benefits concierge service handles for employees. Our employer clients' employees have access to dedicated support that resolves these issues end-to-end. [Talk to us](/talk-to-us).
...
[^2]: For information on federal protections against surprise out-of-network billing, see [CMS guidance on the No Surprises Act](https://www.cms.gov/nosurprises). Federal rules limit out-of-network billing in emergency situations and for non-emergency services at in-network facilities.
