---
title: "Coinsurance vs Copay: A Plain-English Breakdown"
type: blog
excerpt: "Both coinsurance and copays are forms of cost-sharing, but they work differently. Here's how each one shows up on your health plan and what it means for what you actually pay."
publishedDate: 2026-04-24
audienceTags: ["Employee", "All", "HR"]
topicTags: ["Plan Structures", "Getting Started"]
difficulty: beginner
contentCluster: Plan Types
seoTitle: "Coinsurance vs Copay: How They Differ in Health Insurance"
seoDescription: "How coinsurance and copays differ in a health insurance plan, when each applies, and how to think about what you'll actually pay for care."
keywords:
...
keyTakeaways:
  - "A copay is a flat dollar amount you pay for a specific service (e.g., $30 per office visit)."
  - "Coinsurance is a percentage of the cost of a service that you pay (e.g., 20% of the cost), with the plan paying the rest."
  - "Copays often apply to predictable, routine services. Coinsurance often kicks in for higher-cost procedures, hospitalizations, or out-of-network care."
  - "Most plans use a mix of both: copays for office visits and prescriptions; coinsurance for major procedures and hospital stays."
  - "Both copays and coinsurance count toward your out-of-pocket maximum, capping your total annual exposure."
faqs:
  - question: "What is the difference between coinsurance and copay?"
    answer: "A copay is a fixed dollar amount you pay for a covered service — for example, $30 for an in-network primary care visit. Coinsurance is a percentage of the cost you pay — for example, 20% of the negotiated rate for a procedure, with the plan paying the remaining 80%. Copays are predictable; coinsurance varies with the cost of the service."
  - question: "Which is better, coinsurance or copay?"
    answer: "Neither is universally better — most health plans use a mix of both. Copays make routine costs predictable (you know your office visit will be $30). Coinsurance distributes responsibility on more expensive services. The right design depends on the plan structure and your expected utilization."
  - question: "When does coinsurance apply?"
    answer: "Coinsurance typically applies to non-routine services like surgeries, hospital stays, advanced imaging, and out-of-network care. It usually applies after you've met your deductible. So your sequence is: pay full cost up to deductible → then pay coinsurance share of cost → then plan pays 100% once you hit the out-of-pocket maximum."
  - question: "Do copays count toward the deductible?"
    answer: "Usually no. In most modern plans, copays do not count toward the deductible — they're a separate cost-sharing mechanism for routine services. They do, however, count toward the out-of-pocket maximum in most plans. Plan designs vary, so check your specific Summary of Benefits and Coverage."
  - question: "What's the typical coinsurance percentage for in-network care?"
    answer: "It varies by plan, but a common in-network coinsurance percentage is 20% (with the plan paying the remaining 80%). Some plans have lower coinsurance (10-15%) on richer designs, or higher coinsurance (30-40%) on plans with lower premiums. Out-of-network coinsurance is typically much higher, when out-of-network coverage is offered at all."
  - question: "Do copays and coinsurance both count toward the out-of-pocket maximum?"
    answer: "Yes, in most modern plans. Both copays and coinsurance — along with deductible spending — count toward your annual out-of-pocket maximum. Once you hit that maximum, the plan covers 100% of in-network covered services for the remainder of the plan year. Premiums are separate and don't count toward the OOP max."
...
| Service category | Typical cost-sharing |
|---|---|
| Preventive care | $0 (covered by ACA-required preventive services) |
| Primary care office visit | Copay (after deductible on some HDHPs) |
| Specialist visit | Copay (after deductible on some HDHPs) |
| Urgent care | Copay |
| Emergency room | Copay (often higher) |
| Generic prescription | Copay |
| Brand prescription | Copay or coinsurance |
| Specialty drug | Coinsurance (often) |
| Outpatient surgery | Coinsurance (after deductible) |
| Inpatient hospital | Coinsurance (after deductible) |
| Advanced imaging | Coinsurance (after deductible) |
| Out-of-network care | Higher coinsurance (when covered at all) |
...
[Deductible vs Out-of-Pocket Maximum](/learn/plan-types/deductible-vs-out-of-pocket-maximum) walks through how the two ceiling numbers work together.
...
> **Want help understanding your specific health plan or comparing plan options?** We can walk through Summary of Benefits and Coverage documents and model expected total cost at different usage levels for any plan you're considering. [Talk to us](/talk-to-us).
